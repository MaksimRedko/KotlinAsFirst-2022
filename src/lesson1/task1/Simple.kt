 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (sagenes * 48 * 4.445 + arshins * 16 * 4.445 + vershoks * 4.445) * 0.01
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = PI * (deg + min / 60.0 + sec / 3600.0) / 180
...
fun numberRevert(number: Int): Int =
    number / 100 + number % 10 * 100 + (number / 10) % 10 * 10
